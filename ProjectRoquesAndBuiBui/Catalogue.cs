...
namespace ProjectRoquesAndBuiBui
{
    class Catalogue
    {
        ...
        public Catalogue()
        {
            ...
            catalogues.Add(new CompagnieElectricite(17000000, 50, 220, 250, 15000, "Central nucléaire", 1000000, 3, ConsoleColor.Yellow));
            catalogues.Add(new CompagnieTransport(1, 200, 2, 0, 25000, "Bus RATP", 1000000, 3, ConsoleColor.Green));
            catalogues.Add(new BatimentAdministratif(1000, 100, "Mairie", 15000, 2, ConsoleColor.White));
            ...
            catalogues.Add(new Logement(2500, ClasseSocial.moyenne, 0, 30000, "Pavillon", 2000000, 3, ConsoleColor.DarkMagenta));
            catalogues.Add(new Logement(600, ClasseSocial.aisee, 0, 40000, "Villa", 5000000, 2, ConsoleColor.DarkYellow));
            catalogues.Add(new Logement(3000, ClasseSocial.ouvriere, 0, 20000, "Immeuble", 5000000, 2, ConsoleColor.DarkYellow));
            catalogues.Add(new Primaire(500,100,50,6000, 15000, "Ferme", 3000000, 4, ConsoleColor.DarkRed));
            catalogues.Add(new Tourisme(8, 40, "Jardin Babylonne", 400, 1, ConsoleColor.DarkGreen));
